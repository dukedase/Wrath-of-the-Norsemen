...
NGame = {
	...
	DAYS_BEHIND_PAUSE = 40,					-- In multiplayer, if the slowest player is lagging behind this amount of days, the game will pause
...
NCountry = {
	...
	ADDITIONAL_MIN_DEVELOPMENT_FOR_GOV_RANK_X = 1000,	-- ADDITIONAL development needed to upgrade to government rank above 3
...
NMilitary = {
	...
	WAR_LENGTH_DAMAGE_MODIFIER = 0.005,				-- How much (by percentage) the damage dealt will be increased each day of the combat
	...
	LOW_MORALE_THRESHOLD = 0.5,					-- Under this percentage of the morale, the army will do a shattered retreat
